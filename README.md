...
interest investigation. It writes bounded provisional state, creditor, and bank
observations to `interest_probe.csv` without applying the historical fix. Its
fields and limits are documented in
